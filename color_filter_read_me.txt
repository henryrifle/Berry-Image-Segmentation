...
Replace directory variable with the directory path that your iamges are in

Replace filename variable with the name of the image you would want to segment
